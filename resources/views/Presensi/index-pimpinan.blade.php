                    ...
                    <div class="row d-flex justify-content-end mb-3">
                        ...
                        <div class="col-md-12 col-lg-2 col-sm-12 text-right">
                            <select class="form-control" id="pilih_jadwal">
                                ...
                                @foreach (\App\Jadwal::get() as $item)
                        ...
                        <table class="table table-bordered table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2" class="text-left align-middle">Unit Kerja</th>
                                    <th rowspan="2" class="text-center align-middle">Status</th>
                                    <th colspan="4" class="text-center">Presensi
                                        {{ $tanggal->translatedFormat('l, d F Y') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($masuk != null && !$masuk->auto_presensi)
                                            <select name="gantiStatus" id="gantiStatus" class="form-control fomr-control-sm gantiStatus" {{ $masuk['auto_presensi'] ? 'disabled':'' }}>
...
<script>
    $('.viewImage').on('click', function(){
            ...
            Swal.fire({
                ...
                html: `<strong>${this.getAttribute('data-nama')}</strong> <br/>${this.getAttribute('data-text')} | Terlambat ${this.getAttribute('data-telat')}`,
