<div class="border border-primary rounded p-3 mb-3">
    <form wire:submit.prevent="store">
        <div class="form-group">
            ...
            <input type="text" wire:model="nama_instansi" class="form-control @error('nama_instansi') is-invalid @enderror input-sm"  placeholder="Nama Instansi">
            @error('nama_instansi')
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('range_masuk') is-invalid @enderror input-sm" placeholder="default 0,0" wire:model="range_masuk">
                    @error('range_masuk')
                    <span class="invalid-feedback">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-sm-3 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('range_istirahat') is-invalid @enderror input-sm" placeholder="default 0,0" wire:model="range_istirahat">
            ...
            <div class="col-sm-3 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('range_pulang') is-invalid @enderror input-sm" placeholder="default 0,0" wire:model="range_pulang">
                    @error('range_pulang')
                    <span class="invalid-feedback">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <button class="btn btn-primary btn-block">Buat Pengaturan</button>
    </form>
</div>
