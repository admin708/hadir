<!-- app footer -->
<div class="text-center bg-transparent no-border mt-5">

    <img src="assets/img/logo.png" alt="icon" class="footer-logo mb-2 mt-5">
    <div class="footer-title">
        © {{ date('Y') }}. Presensi FH.
    </div>
    <div>Kreatiftren Media Teknologi</div>
