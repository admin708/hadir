...
function onlineModeToast() {
    // $("body").append(
    //     "<div id='online-toast' class='toast-box bg-success toast-center tap-to-close'>"
    //     +
    ...
    $("body").append(`
        <div id="online-toast" class="toast-box toast-center tap-to-close">
            <div class="in">
...
function offlineModeToast() {
    ...
    $("body").append(`
         <div id="offline-toast" class="toast-box toast-center">
            <div class="in">
