...
// var getPage = localStorage.getItem('currentPageId');
// var currentPageId = getPage === null ? 'page_home':getPage;
// var currentSelectorId = getPage === null ? 'home':getPage.split('-')[1];
...
window.onload = function(){
    ...
    // document.getElementById(currentPageId).addClass('')
